...
# Rectangle Log Information
logger.info(
    f"Given Rectangle Length={rectangle_length} and Rectangle Width={rectangle_width}, Rectangle Area = {rectangle_area}"
)
